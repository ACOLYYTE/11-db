...
public class AcolyteTest {
    ...
    public static void delete_type(int id) throws SQLException {
        stat.execute("DELETE FROM 'types' WHERE id=='" + id + "';");
    }

    public static void update_type(int id, String type) throws SQLException {
        stat.execute("UPDATE 'types' SET 'type'=='" + type + "' WHERE id=='" + id + "';");
    }
    ...
    public static void delete_cat(int id) throws SQLException {
        stat.execute("DELETE FROM cats WHERE id==" + id + ";");
    }

    public static void delete_cat(String where) throws SQLException {
        stat.execute("DELETE FROM cats WHERE " + where + ";");
    }

    public static void update_cat(int id, String set, String where) throws SQLException {
        stat.execute("UPDATE cats SET " + set + " WHERE " + where + "; ");
    }

    public static void get_cat(int id) throws SQLException {
        resSet = stat.executeQuery("SELECT * FROM cats WHERE id==" + id + ";");
        while (resSet.next()) {
            System.out.println(resSet.getString("name") + " " + resSet.getInt("id") + " " + resSet.getInt("age") + " " + resSet.getDouble("weight")+" "+resSet.getInt("type_id"));
        }
    }

    public static void get_cat(String where) throws SQLException {
        resSet = stat.executeQuery("SELECT * FROM cats WHERE " + where + ";");
    ...
    public static void get_all_cats() throws SQLException {
        resSet = stat.executeQuery("SELECT * FROM cats");
        while (resSet.next()) {
            System.out.println(resSet.getString("name") + " " + resSet.getInt("id") + " " + resSet.getInt("age") + " " + resSet.getDouble("weight")+" "+resSet.getInt("type_id"));}
